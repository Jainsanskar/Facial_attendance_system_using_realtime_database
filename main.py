...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket':"realtimefaceattendance-ca222.appspot.com"
})
...
while True:
    ...
    imgBackground[162:162 + 480, 55:55 + 640] = img  # webcam
    imgBackground[44:44 + 633, 808:808 + 414] = imageModeList[modeType]  # mode
        ...
        if counter!=0:
            ...
            if modeType!=3:
                ...
                if counter<=10:
                    ...
                    offset = (441-w)//2
                    cv2.putText(imgBackground, str(studentInfo['name']), (802+offset, 445), cv2.FONT_HERSHEY_COMPLEX, 1,
                                    (50, 50, 50), 1)
